...
>(({className, showShadows = true, children, ...props}, ref) => {
  ...
  return (
    <div 
      className={cn(
        'relative',
        'before:absolute before:-left-1 before:top-0 before:z-[1] before:block before:h-full before:w-10 before:opacity-0 before:bg-gradient-to-r before:from-primary before:pointer-events-none',
        'after:absolute after:-right-1 after:top-0 after:z-[1] after:block after:h-full after:w-10 after:bg-gradient-to-l after:from-primary after:pointer-events-none',
